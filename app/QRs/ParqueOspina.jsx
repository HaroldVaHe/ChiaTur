...
export default function ParqueOspina() {
    ...
    <View style={{ flex: 1 }}>
      <ScrollView contentContainerStyle={styles.topSection}>
        <Image
          ...
          style={styles.logo}
        />
        <Text style={styles.title}>Parque Ospina</Text>
        <Text style={styles.factText}>
          El Parque Ospina es uno de los pulmones verdes más importantes de la ciudad de Chía. 
          Este lugar es ideal para pasar tiempo al aire libre, realizar actividades recreativas y disfrutar de la naturaleza.
        </Text>
 <Image
          source={require('@/assets/images/ParqueOspina.jpg')}
          style={styles.image}
        />
      </ScrollView>
