...
export default function Valvanera() {
    ...
    <View style={{ flex: 1 }}>
      <ScrollView contentContainerStyle={styles.topSection}>
        <Image
          ...
          style={styles.logo}
        />
        <Text style={styles.title}>Santuario de Valvanera</Text>
        <Text style={styles.factText}>
          El Santuario de Valvanera es un lugar religioso y natural emblemático de Chía.
          Su arquitectura colonial y su ubicación en las montañas lo convierten en un sitio
          ideal para el retiro espiritual y el turismo religioso.
        </Text>
        <Image
          source={require('@/assets/images/Valvanera.jpg')}
          style={styles.image}
        />
      </ScrollView>
