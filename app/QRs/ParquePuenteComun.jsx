...
export default function ParquePuenteComun() {
    ...
    <View style={{ flex: 1 }}>
      <ScrollView contentContainerStyle={styles.topSection}>
        <Image
          ...
          style={styles.logo}
        />
        <Text style={styles.title}>Parque Puente del Común</Text>
        <Text style={styles.factText}>
          Este puente colonial del siglo XVIII es un ícono de la arquitectura e
          historia de Chía. Fue construido sobre el río Bogotá y conecta con
          Bogotá por el norte.
        </Text>
        <Image
          source={require('@/assets/images/ParquePuenteComun.jpeg')}
          style={styles.image}
        />
      </ScrollView>
