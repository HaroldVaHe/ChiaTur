...
export default function CasaDeLaCultura() {
    ...
    <View style={{ flex: 1 }}>
      <ScrollView contentContainerStyle={styles.topSection}>
        ...
        <Text style={styles.factText}>
          La Casa de la Cultura es el centro neurálgico para el desarrollo artístico y cultural de la comunidad de Chía. 
          Ofrece una variedad de actividades y eventos culturales, como exposiciones, talleres y presentaciones en vivo.
        </Text>
         <Image
          source={require('@/assets/images/CasaCultura.png')}
          style={styles.image}
        />
      </ScrollView>
