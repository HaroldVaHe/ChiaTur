...
export default function ViewShopping() {
      ...
      try {
        const query = `
          ...
          (
            ...
            node["amenity"="marketplace"](4.83,-74.1,4.9,-74.03);
            node["building"="mall"](4.83,-74.1,4.9,-74.03);
            node["building"="retail"](4.83,-74.1,4.9,-74.03);
            node["amenity"="shopping_centre"](4.83,-74.1,4.9,-74.03);
          );
          out body;
        `;
...
// Estilos (iguales a las otras vistas)
